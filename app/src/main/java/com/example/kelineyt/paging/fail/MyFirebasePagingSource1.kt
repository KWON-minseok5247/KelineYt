...
//class MyFirebasePagingSource1(private val queryProductsByName: Query) :
...
//            val a = queryProductsByName.get().await().documents
...
////        Log.d("FirebaseQuery", "Query result size: ${querySnapshot.documents.size}")
////
